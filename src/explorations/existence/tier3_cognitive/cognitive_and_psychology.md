...
In [`draft.md` §2.3.4 & §4](../core_ontology/draft.md), a cognitive agent ( $E \in T_{\text{III}}$ ) operates across complexified phase space $\Omega_{\mathbb{C}} = \Omega_{\mathbb{R}} \oplus i \Omega_{\mathfrak{Im}}$:
...
• Computation entropy: Ḣ ≈ 0                    • Ė_veto = k_B T ln 2 · Ḣ_erasure > 0
