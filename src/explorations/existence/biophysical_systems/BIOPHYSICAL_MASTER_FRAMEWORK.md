# Biophysical Systems Master Framework: Non-Equilibrium Continuum Mechanics and Metabolic Thermodynamics of Living Systems and Syncytia
...
**Companion Documents:** [`biophysical_framework.md`](biophysical_framework.md), [`biophysical_cosmological_ontology.md`](biophysical_cosmological_ontology.md)
...
| :--- | :--- | :--- |
| **Quantum Radical-Pair Coherence** | Master Eq. 1 | [`biophysical_framework.md`](biophysical_framework.md) **§4.1** |
| **ATP Motor Catalysis Kinetics** | Master Eq. 2 | [`biophysical_framework.md`](biophysical_framework.md) **§4.1** |
| **Brownian Ratchet Membrane Mechanics** | Master Eq. 3 | [`biophysical_framework.md`](biophysical_framework.md) **§4.3** |
| **Manifold Reaction-Diffusion Waves** | Master Eq. 4 | [`biophysical_framework.md`](biophysical_framework.md) **§4.3** |
| **Metabolic Starvation & Lysis Bound** | Master Eq. 5 | [`biophysical_framework.md`](biophysical_framework.md) **§4.2** |
| **Grotthuss Proton Wires & Bioenergetics**| Proton hopping conductance | [`biophysical_cosmological_ontology.md`](biophysical_cosmological_ontology.md) **§3** |
| **High-Frequency Damköhler Dispersion** | $\mathrm{Da}_{\text{boundary}} < 1$ | [`biophysical_framework.md`](biophysical_framework.md) **§4.3** |
