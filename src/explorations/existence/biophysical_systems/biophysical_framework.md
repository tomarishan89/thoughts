...
> **Scope Note:** This treatise preserves the Tier II biophysical, cellular, and syncytial continuum mechanics formulations formally segregated from the Tier 1 relativistic physics and cosmology framework ([relativistic_cosmology_framework.md](../physical_systems/cosmology_and_black_holes/relativistic_cosmology_framework.md)), adhering to the paper submission scope policy documented in [issues_log.md](../physical_systems/cosmology_and_black_holes/issues_log.md).
