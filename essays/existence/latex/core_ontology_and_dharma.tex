...
\section{3. Set-Theoretic Subsetting \& The Inflorescence Model}
...
\subsection{Universal Matrix vs. Localized Instantiation}
...
3. \textbf{Proper Subsetting:} A finite physical system does not embody the total universal matrix of all physical laws; it is governed by and instantiates a localized proper subset:
...
\subsection{The Mechanics of Cross-Domain Overreach (\textit{Paradharma}):}
