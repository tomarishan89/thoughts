...
In \href{../draft.md}{\texttt{draft.md} \S 2.3.4 \\& \S 4}, a cognitive agent ($E \in T_{\text{III}}$) operates across complexified phase space $\Omega_{\mathbb{C}} = \Omega_{\mathbb{R}} \oplus i \Omega_{\mathfrak{Im}}$:
