...
$$E^{\text{DNA}}(t) = \Psi\left[ E^{\text{DNA}}(0); \; \{\mathcal{O}_{\text{transcription}}, \mathcal{O}_{\text{methylation}}, \mathcal{O}_{\text{replication}}\}_0^t \right]$$
